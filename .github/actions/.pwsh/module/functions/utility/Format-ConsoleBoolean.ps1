...
.DESCRIPTION
    The cmdlet decorates a boolean value for console viewing and returns it.
    If the **Value** is `$true`, it is returned bright blue. If the **Value** is
    `$false`, it is returned bright magenta.
.PARAMETER Value
...
.EXAMPLE
    ...
    The cmdlet shows the styling for console viewing; the first statement shows
    "True" in bright blue, the second shows "False" in bright magenta.
#>
